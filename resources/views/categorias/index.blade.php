        ...
        <tr>
            ...
            <td>
                <div class="action-buttons">
                    <button class="btn btn-success btn-sm btn-edit" data-id="{{ $categoria->id_categoria }}"
...
<div class="d-flex justify-content-start mt-4">
    ...
    <a href="{{ route('descargarPDF.descargarCategorias') }}" class="btn btn-warning me-4" style="background-color: #f0ad4e; border-color: #eea236; margin-left: 8px;">Descargar listado</a> <!-- Botón para descargar el PDF -->
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" method="POST" action="{{ route('categorias.store') }}">
                    @csrf
