    ...
    public function up()
{
    Schema::create('alquileres', function (Blueprint $table) {
        ...
        $table->string('dni_cliente');  // Este es el campo que se relaciona con la tabla `clientes`
        $table->foreign('dni_cliente')->references('dni')->on('clientes')->onDelete('cascade');
        $table->integer('id_pelicula');  // Este es el campo que se relaciona con la tabla `peliculas`
