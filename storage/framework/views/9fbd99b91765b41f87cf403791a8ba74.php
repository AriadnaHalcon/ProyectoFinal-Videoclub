...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo e($cliente->tarifa->nombre); ?></td>
            <td>
                <button class="btn btn-success edit-btn" data-id="<?php echo e($cliente->dni); ?>">Editar</button>
                <form class="delete-form" action="<?php echo e(route('clientes.destroy', $cliente->dni)); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
...
<div class="d-flex justify-content-start mt-4">
    ...
    <a href="<?php echo e(route('descargarPDF.descargarClientes')); ?>" class="btn btn-warning me-4" style="background-color: #f0ad4e; border-color: #eea236; margin-left: 8px;">Descargar listado</a> <!-- Botón para descargar el PDF -->
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" method="POST" action="<?php echo e(route('clientes.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="addTarifa" name="id_tarifa">
                            <?php $__currentLoopData = $tarifas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarifa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($tarifa->id_tarifa); ?>"><?php echo e($tarifa->nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Otros\Desktop\PHP\videoclub2\resources\views/clientes/index.blade.php ENDPATH**/ ?>