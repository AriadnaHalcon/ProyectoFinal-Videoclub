...
<div class="container">
    ...
    <table class="table table-striped mt-3">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo e($tarifa->id_tarifa); ?></td>
                <td><?php echo e($tarifa->nombre); ?></td>
                <td><?php echo e($tarifa->descuento); ?>%</td>
                <td>
                    <div class="action-buttons">
                        <button class="btn btn-success btn-sm btn-edit" data-id="<?php echo e($tarifa->id_tarifa); ?>"
                            data-nombre="<?php echo e($tarifa->nombre); ?>" data-descuento="<?php echo e($tarifa->descuento); ?>"
                            data-bs-toggle="modal" data-bs-target="#editModal">
                            Editar
                        </button>
                        <form action="<?php echo e(route('tarifas.destroy', $tarifa->id_tarifa)); ?>" method="POST"
    ...
    <div class="d-flex justify-content-start mt-4">
        ...
        <a href="<?php echo e(route('descargarPDF.descargarTarifas')); ?>" class="btn btn-warning me-4" style="background-color: #f0ad4e; border-color: #eea236; margin-left: 8px;">Descargar listado</a> <!-- Botón para descargar el PDF -->
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" method="POST" action="<?php echo e(route('tarifas.store')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Otros\Desktop\PHP\videoclub2\resources\views/tarifas/index.blade.php ENDPATH**/ ?>