...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <td><?php echo e($alquiler->cliente->nombre); ?></td>
            <td><?php echo e($alquiler->pelicula->titulo); ?></td>
            <td><?php echo e($alquiler->fecha_alquiler); ?></td>
            <td><?php echo e($alquiler->fecha_devolucion); ?></td>
            <td><?php echo e($alquiler->estado); ?></td>
            <td><?php echo e($alquiler->precio_rebajado ? '€' . number_format($alquiler->precio_rebajado, 2) : 'No rebajado'); ?></td>
            <td>
                <div class="action-buttons">
                    <button class="btn btn-success btn-sm btn-edit" data-id="<?php echo e($alquiler->id_alquiler); ?>"
                        data-dni_cliente="<?php echo e($alquiler->dni_cliente); ?>" data-id_pelicula="<?php echo e($alquiler->id_pelicula); ?>"
                        data-fecha_alquiler="<?php echo e($alquiler->fecha_alquiler); ?>" data-fecha_devolucion="<?php echo e($alquiler->fecha_devolucion); ?>"
                        data-estado="<?php echo e($alquiler->estado); ?>" data-precio_rebajado="<?php echo e($alquiler->precio_rebajado); ?>"
                        data-bs-toggle="modal" data-bs-target="#editModal">
                        Editar
                    </button>
                    <form action="<?php echo e(route('alquileres.destroy', $alquiler->id_alquiler)); ?>" method="POST"
...
<div class="d-flex justify-content-start mt-4">
    ...
    <a href="<?php echo e(route('descargarPDF.descargarAlquileres')); ?>" class="btn btn-warning me-4" style="background-color: #f0ad4e; border-color: #eea236; margin-left: 8px;">Descargar listado</a> <!-- Botón para descargar el PDF -->
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm" method="POST" action="<?php echo e(route('alquileres.store')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="addCliente" name="dni_cliente" required>
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($cliente->dni); ?>"><?php echo e($cliente->nombre); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" id="addPelicula" name="id_pelicula" required>
                            <?php $__currentLoopData = $peliculas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pelicula): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pelicula->id_pelicula); ?>"><?php echo e($pelicula->titulo); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Otros\Desktop\PHP\videoclub2\resources\views/alquileres/index.blade.php ENDPATH**/ ?>